...
def gen_config(args, name):

    if name != '':
        # generate config from a sequence name

        #seq_home = '/home/zzy/workspace/mdnet/dataset/ss'
        seq_home = '/home/zhaokangkang/mdnet/dataset/OTB'
        save_home = '../result_fig'
        result_home = '../result'
        
        seq_name = name
        img_dir = os.path.join(seq_home, seq_name, 'img')
        gt_path = os.path.join(seq_home, seq_name, 'new_groundtruth_rect.txt')
